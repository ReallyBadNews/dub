          ...
          <MjmlSection padding="0">
            <MjmlColumn>
              <MjmlImage
                ...
                padding="0"
                align="left"
                src="https://dewbie.vercel.app/_static/thumbnail.png"
              />
            </MjmlColumn>
          </MjmlSection>
          <MjmlSection cssClass="smooth">
            <MjmlColumn>
              ...
              <MjmlText cssClass="li">
                •&nbsp;&nbsp;Create a custom{" "}
                <a href="https://app.dewbie.vercel.app/links" target="_blank">
                  Dub.sh short link
                </a>
              </MjmlText>
              <MjmlText cssClass="li">
                •&nbsp;&nbsp;Create a new{" "}
                <a href="https://app.dewbie.vercel.app/" target="_blank">
                  project
                </a>{" "}
